...
<br>
  The ability to rank architecturally dissimilar notetypes by their contents using NLP techniques was the impetus for creating this app and its namesake. Previously, I had journaled on paper. I realized that oftentimes, what I find myself thinking about I had already thought and wrote about previously. In a notebook, even if I knew I had wrote a few paragraphs about a topic, it would be impossible to find due to notebooks having a pretty bad organizational strucuture (paper pages). I realized that if I were to make a program to organize notes by their contents, not their name, date, or directory, then I could write my daily journal and then instantly be presented with my previous thoughts on that topic, even if I had forgot about their existence. This is where the analogy comes from. The structure resembles a spiderweb, instead of a traditional structure such as a tree or a list.
