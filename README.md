...
Anyone can feel free to use code from this project for making javafx applications or any project. (Code from earlier commits often follows poor coding practice in JavaFX).
